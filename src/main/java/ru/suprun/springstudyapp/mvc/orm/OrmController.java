package ru.suprun.springstudyapp.mvc.orm;
...
public class OrmController
{
    ...
    public ModelAndView ormUpdateUser(@PathVariable(value = "iduser") int iduser, @PathVariable(value = "enabled") boolean enabled)
    {
