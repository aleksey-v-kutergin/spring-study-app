...
import ru.suprun.springstudyapp.mvc.rest.model.RestPostsModel;
import ru.suprun.springstudyapp.mvc.rest.model.RestUserModel;

import java.util.Arrays;
import java.util.List;

@RestController
//will add automatically the @ResponseBody annotation to all methods
